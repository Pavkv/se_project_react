...
export default function EditProfileModal({onClose, isOpen, isLoading, setLoading, setCurrentUser}) {
    ...
    return (
        <ModalWithForm onClose={onClose} isOpen={isOpen} name="edit-profile" title="Change profile data"
                       buttonText={isLoading ? "Saving" : "Save Changes"} inputs={1} onSubmit={handleSubmit}
                       setLoading={setLoading} prefillValues={{
